...
import com.nagp.controllers.InitMethod;
import org.testng.*;
...
public class ExtentTestNGIReporterListener extends InitMethod implements IReporter {
	...
	public void generateReport(List xmlSuites, List suites, String outputDirectory) {
		...
		extent.setSystemInfo("Author", "Sanjeet");
	...
	private void init() {
		...
		sparkReporter.config().setDocumentTitle("Extent Report_Sanjeet");
		sparkReporter.config().setReportName("Extent Report_Sanjeet");
